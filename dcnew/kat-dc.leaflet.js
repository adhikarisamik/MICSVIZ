dc.leafletChart = function(_chart) {
    ...
    _info.update = function (props) {
        this._div.innerHTML = '<h4>District-wise casualties and damages</h4>' +  (props ?
            '<b>' + props.key + '</b><br />' + props.value.average + ' events above threshold'
    ...
    _legend.update = function () {
        ...
        var div = L.DomUtil.create('div', 'info legend'),
            grades = [50, 100, 500, 1500,2000,3000],
            labels = [];
